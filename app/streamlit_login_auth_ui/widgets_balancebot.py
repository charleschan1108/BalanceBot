...
from .utils import check_usr_email_and_retrieve_user_info
    ...
    def login_widget(self) -> None:
        ...
        if st.session_state['LOGGED_IN'] == False:
            ...
            with del_login.form("Login Form"):
                username = st.text_input("Username", placeholder = 'Your registered email')
                ...
                if login_submit_button == True:
                    user_info = check_usr_email_and_retrieve_user_info(username, password) # return None if no matched email is found
                    ...
                    if bool(user_info) == False:
                        ...
                        self.cookies.save()
                        del_login.empty()
                        st.session_state["__user_cache__"] = user_info
